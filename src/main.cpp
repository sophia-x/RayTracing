...
int main() {
	...
	scene.addModel(Plane (vec3(13, 7.4, -7), vec3(-13, 7.4, -7), vec3(-13, -7.4, -7),
	                      vec3(13, -7.4, -7), 							vec3(0.7), Material(0.5, 0.0, 00, 0.0, 0.0, 0.0, 0.00)));
	scene.addModel(Plane (vec3(13, -2, -7), vec3(-13, -2, -7), vec3(-13, -2, 7),
	                      vec3(13, -2, 7), 								vec3(0.7), Material(0.5, 0.0, 00, 0.0, 0.0, 0.0, 0.00)));
	scene.addModel(new SphereModel(vec3(0.0, 0.0, -4), 0.5, 			vec3(1.0, 0.0, 0.0), Material(1.0, 1.0, 10, 0.0, 0.0, 0.0, 0.00)));
	scene.addModel(new SphereModel(vec3(1.3, 0.0, -3), 0.5, 			vec3(0.0, 1.0, 0.0), Material(1.0, 1.0, 10, 0.0, 0.0, 0.0, 0.00)));
	scene.addModel(new SphereModel(vec3(-2.0, 0.0, -5), 0.5, 			vec3(0.0, 0.0, 1.0), Material(1.0, 1.0, 10, 0.0, 0.0, 0.0, 0.00)));
