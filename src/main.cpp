...
Mat scene_a() {
	...
	//ground plane
	scene.addModel(Plane (vec3(13, -2, -10), vec3(-13, -2, -10), vec3(-13, -2, 0), vec3(13, -2, 0),
	                      vec2(1.0, 0.0), vec2(0.0, 0.0), vec2(0.0, 1.0), vec2(1.0, 1.0),
	                      Material(chess_board, 1, 1, vec3(1.0), 0.5, 0.0, 00, 0.0, 0.0, 0.0, 0.00)));
	// Spheres
	scene.addModel(new SphereModel(vec3(0.0, 0.0, -4), 0.5, 			Material(vec3(1.0, 1.0, 1.0), 0.0, 0.0, 00, 0.0, 1.0, 1.3, 0.05)));
	scene.addModel(new SphereModel(vec3(1.3, 0.0, -3), 0.5, 			Material(vec3(1.0, 1.0, 1.0), 0.0, 0.0, 00, 0.0, 1.0, 1.3, 0.00)));
	scene.addModel(new SphereModel(vec3(-2.0, 0.0, -5), 0.5, 			Material(vec3(1.0, 1.0, 1.0), 0.1, 1.0, 20, 0.0, 1.0, 1.3, 0.15)));
