...
int main() {
	...
	scene.addModel(new Mesh  ("objs/Arma.obj", threshold, vec3(0.7),					0.5, 0.3, specular_power, 	0.0, 0.0, 0.0,  0.0, absorbance));
	...
	PinHoleCamera camera(vec4(vec3(0, 0, 5), 1), vec4(0, 0, -1, 0), vec4(0, 1, 0, 0), radians(30.0f), radio, 1);
